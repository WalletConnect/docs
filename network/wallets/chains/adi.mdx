...
As an EVM-compatible chain, ADI Chain supports all standard Ethereum JSON-RPC methods. Wallets implementing ADI Chain support should refer to the [EVM RPC documentation](/network/wallets/chains/evm) for the complete list of supported methods, including:
...
For detailed method specifications and examples, see the [EVM Chain Support](/network/wallets/chains/evm) page.
