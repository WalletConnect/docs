...
<video
  controls
  autoPlay
  src="https://mintlify.s3.us-west-1.amazonaws.com/reown-5552f0bb/images/link-mode.mp4"
...
<CardGroup cols={2}>
    <Card title="Android" icon="android" href="/network/wallets/android/link-mode">
        Get started with Link Mode in WalletKit - Android.
    </Card>
    <Card title="iOS" icon="apple" href="/network/wallets/ios/link-mode">
        Get started with Link Mode in WalletKit - iOS.
    </Card>
    <Card title="Flutter" icon="flutter" href="/network/wallets/flutter/link-mode">
        Get started with Link Mode in WalletKit - Flutter.
    </Card>
    <Card title="React Native" icon="react" href="/network/wallets/react-native/link-mode">
