...
### Final Notes 
+ public API documentation can be found [here](/network/wallets/web/usage)
+ `auth_request` is deprecated in favor of `session_authenticate`. Docs can be found [here](/network/wallets/web/one-click-auth)
