...
<CardGroup cols={2}>
  <Card title="Android" icon="android" href="/network/wallets/android/installation">
    Get started with Wallet SDK in Android.
  </Card>

  <Card title="iOS" icon="apple" href="/network/wallets/ios/installation">
    Get started with Wallet SDK in iOS.
  </Card>

  <Card title="React Native" icon="react" href="/network/wallets/react-native/installation">
    Get started with Wallet SDK in React Native.
  </Card>

  <Card title="Flutter" icon="flutter" href="/network/wallets/flutter/installation">
    Get started with Wallet SDK in Flutter.
  </Card>

  <Card title="Web" icon="js" href="/network/wallets/web/installation">
    Get started with Wallet SDK in Web.
  </Card>

  <Card title=".NET" icon="code" href="/network/wallets/c-sharp/installation">
