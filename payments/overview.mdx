...
Every integration can be built and verified end to end in [test mode](/payments/merchant/test-mode) — same API, no real funds — before going live.
...
<CardGroup cols={2}>
  ...
  <Card title="Merchant Quickstart" icon="rocket" href="/payments/merchant/quickstart">
    Create your first test payment via the Merchant API in six steps.
  </Card>
  <Card title="Test Mode" icon="flask" href="/payments/merchant/test-mode">
    Build and verify your integration without moving real funds.
  </Card>
</CardGroup>