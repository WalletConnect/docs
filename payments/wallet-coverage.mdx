...
For the full, always-current directory, point your customers at [WalletGuide](https://walletguide.walletconnect.com/).
...
<CardGroup cols={1}>
  <Card title="WalletGuide" icon="globe" href="https://walletguide.walletconnect.com/">
