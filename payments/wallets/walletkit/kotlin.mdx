...
- **WalletKit**: 1.9.0+ (`com.reown:walletkit`)
- **WalletConnect Pay**: 1.3.0+ (`com.walletconnect:pay`, bundled with WalletKit; ships yttrium-wcpay 0.10.60). Required for the `data` parameter in `confirmPayment`.
