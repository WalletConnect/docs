...
Some payments may require additional user data. If the selected option requires data collection, complete it **before** fetching the required actions — the backend rejects the actions request unless the information has been captured first:
