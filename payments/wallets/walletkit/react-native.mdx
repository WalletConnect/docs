...
- Node.js 16+
- WalletKit (`@reown/walletkit`) 1.6.0 or later
- `@walletconnect/pay` 1.1.0 or later (bundled with WalletKit)
- `@walletconnect/react-native-compat` 2.25.0 or later (ships the native Yttrium module: yttrium-wcpay 0.10.60 on Android, YttriumWrapper 0.10.59 on iOS)
