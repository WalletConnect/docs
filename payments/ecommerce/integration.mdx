...
A complete working reference implementation is available in the WalletConnect Pay examples repository:

<Card title="WalletConnect Pay Examples" icon="github" href="https://github.com/WalletConnect/walletconnect-pay-examples">
  Full-stack reference apps showing payment creation, checkout redirect, and order verification.
</Card>
