...
WalletConnect Pay lets Payment Service Providers, acquirers, and platforms accept crypto payments on the same runtime that powers our hosted gateway. You choose how much of the experience you own — from a redirect to a hosted page, all the way to a fully branded checkout built inside your own product.
...
<CardGroup cols={2}>
  ...
  <Card title="Headless SDK" icon="cube" href="/payments/psps/headless-sdk/overview">
    Build a **fully branded, fully owned checkout** inside your own product. You get the payment runtime, WCP client, and wallet orchestration as framework-agnostic packages; you bring the UI, branding, and domain.
  </Card>
</CardGroup>
...
The Headless SDK is gated: request access from **Developers → API Keys** in the [dashboard](https://merchant.pay.walletconnect.com/en/api-keys) — see [Request access and collect the Keys](/payments/psps/headless-sdk/overview#request-access-and-collect-the-keys).
