...
# React hosts also need the hook binding:
npm install @walletconnect/pay-react
```
...
<CardGroup cols={2}>
  <Card title="headless-checkout (Next.js)" icon="react" href="https://github.com/WalletConnect/buyer-experience/tree/main/examples/headless-checkout">
    The full React checkout — `<PayAppKitProvider>` + `usePaymentSession`, no `@reown/*` in the app.
  </Card>
  <Card title="headless-checkout-vanilla" icon="js" href="https://github.com/WalletConnect/buyer-experience/tree/main/examples/headless-checkout-vanilla">
