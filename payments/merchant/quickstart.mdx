...
This guide takes you from zero to your first payment in six steps. You'll build in [test mode](/payments/merchant/test-mode) — same API, no real funds — and swap to a live key when you're ready.
...
Once your integration works end to end in test mode, create a **live key** (`wcp_` prefix) in the dashboard and swap it in — same API, same endpoints, no code changes. See [Going live](/payments/merchant/test-mode#going-live) for the details.
