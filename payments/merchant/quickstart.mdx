...
Before you start, make sure you have a dashboard account. KYB is handled in the dashboard and must be approved before payments can settle — but you can create the merchant and call the API in test conditions while approval is in progress.
