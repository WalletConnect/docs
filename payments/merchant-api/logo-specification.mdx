...
<img src="/images/payments/merchant-logo/wallet-payment-screen.png" alt="Wallet payment screen showing the merchant logo above the amount and the selected payment method" style={{ maxWidth: "320px", display: "block" }} />
...
<img src="/images/payments/merchant-logo/buyer-checkout.png" alt="WalletConnect Pay buyer checkout page showing the merchant logo above the amount and the Pay button" style={{ maxWidth: "640px", display: "block" }} />
