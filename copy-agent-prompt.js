...
(function () {
  ...
  var PROMPT = [
    ...
    "   - Read headers: svix-id, svix-timestamp, svix-signature.",
    ...
    "   - svix-signature contains space-separated entries of the form",
    ...
    "   - Reject the delivery if |now - svix-timestamp| > 5 minutes",
    "     (svix-timestamp is unix seconds).",
    "   - On any verification failure, respond 400 and do not process the payload.",
    "",
    "3. On success, respond 200 immediately and hand the parsed event off for",
    "   asynchronous processing. Do not run business logic before responding.",
    "",
    ...
    "     {\"test\": 2432232314}",
    "   - expected svix-signature entry:",
    "     v1,g0hM9SsE+OTPJTGt/tmIKtSyZlE3uFJELVlNIOLJ1OE=",
    "",
    "Write unit tests covering: the vector above verifies successfully; a wrong",
    "signature is rejected; an altered body is rejected; a svix-signature header",
