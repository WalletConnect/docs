...
<CardGroup cols={2}>
  <Card title="React" icon="react" href="/apps/react/installation">
    Get started with WalletConnect as an App in React.
  </Card>

  <Card title="Next.js" icon="apple" href="/apps/next/installation">
    Get started with WalletConnect as an App in Next.js.
  </Card>

  <Card title="Vue" icon="vuejs" href="/apps/vue/installation">
    Get started with WalletConnect as an App in Vue.
  </Card>

  <Card title="JavaScript" icon="js" href="/apps/javascript/installation">
