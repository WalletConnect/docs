...
<CardGroup cols={2}>
    <Card title="Android" icon="android" href="/wallets/android/link-mode">
        Get started with Link Mode in WalletKit - Android.
    </Card>
    <Card title="iOS" icon="apple" href="/wallets/ios/link-mode">
        Get started with Link Mode in WalletKit - iOS.
    </Card>
    <Card title="Flutter" icon="flutter" href="/wallets/flutter/link-mode">
        Get started with Link Mode in WalletKit - Flutter.
    </Card>
    <Card title="React Native" icon="react" href="/wallets/react-native/link-mode">
