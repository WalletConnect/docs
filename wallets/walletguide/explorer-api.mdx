...
By default chains endpoint returns all chains registered under [CASA Namespace](https://github.com/ChainAgnostic/CASA) and that were approved by our Network Partnerships team. To add a new chain, contact our Network Partnerships area at [walletconnect.com/network](https://walletconnect.com/network).
...
Returns all chains registered under [CASA Namespace](https://github.com/ChainAgnostic/CASA) and that were approved by our Network Partnerships team. To add a new chain, contact our Network Partnerships area at [walletconnect.com/network](https://walletconnect.com/network).
