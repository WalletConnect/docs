...
By default chains endpoint returns all chains registered under [CASA Namespace](https://github.com/ChainAgnostic/CASA) and that were approved by our Network Partnerships team. To add a new chain, fill out the application form linked on our [chains and foundations landing page](https://walletconnect.com/solutions/chains-and-foundations).
...
Returns all chains registered under [CASA Namespace](https://github.com/ChainAgnostic/CASA) and that were approved by our Network Partnerships team. To add a new chain, fill out the application form linked on our [chains and foundations landing page](https://walletconnect.com/solutions/chains-and-foundations).
