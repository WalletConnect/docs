export const Container = ({ children, className = "py-14" }) => {
  return (
    <div className={`px-4 lg:px-10 ${className}`}>
      {children}
    </div>
  )
}
...
export const Title = ({ children }) => {
  return (
    <div className="text-gray-900 dark:text-gray-200 text-2xl tracking-tight" style={{ paddingTop: '2.5rem' }}>
      {children}
    </div>
  )
}
